...
{
    internal class ModifyQuestionaryList
    {
        ...
        private static ModifyQuestionaryList CreateFromContext(GetQuestionary_Result result)
        {
            var modify = new ModifyQuestionaryList
            {
                Id = result.Id,
        ...
        public static implicit operator ModifyQuestionaryList(GetQuestionary_Result result) => CreateFromContext(result);
    }
}
